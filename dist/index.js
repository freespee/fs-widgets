...
var TopListWidget = /** @class */ (function () {
    ...
    TopListWidget.prototype.$onChanges = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var SingleValueWidget = /** @class */ (function () {
    ...
    SingleValueWidget.prototype.$onChanges = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var FsData = /** @class */ (function () {
    ...
    Object.defineProperty(FsData.prototype, "dateFormat", {
    ...
    FsData.prototype.parse = function (resp) {
        var _this = this;
        var datasetChartMapping = chartMappings_1.axisChartMappings[resp.dataset];
        var hasParserFunc = datasetChartMapping && datasetChartMapping.hasOwnProperty('parse');
        if (hasParserFunc) {
            resp.datasources.forEach(function (datasource) { return datasource.data.forEach(function (data) {
                datasetChartMapping.parse.apply(data, [{ dateFormat: _this._dateFormat }]);
            }); });
        }
    };
